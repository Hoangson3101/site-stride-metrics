...
import { AlertTriangle, ExternalLink, DollarSign, Users } from "lucide-react";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
...
export function SponsoredUGCAnalysis() {
  ...
  const isWarning = sponsoredPercentage > 20;
      ...
      {isWarning && (
        <Alert variant="destructive" className="border-red-500 bg-red-50 dark:bg-red-950">
          ...
          <AlertDescription className="text-red-800 dark:text-red-200">
            <strong>Cảnh báo:</strong> Tỷ lệ backlink sponsored là {sponsoredPercentage}%, quá cao
            (ngưỡng an toàn: &lt;20%). Hồ sơ có thể bị Google coi là không tự nhiên. Gợi ý: Giảm
            tỷ lệ link trả phí, tăng các link tự nhiên hơn từ nội dung bài viết.
          </AlertDescription>
        </Alert>
      )}
